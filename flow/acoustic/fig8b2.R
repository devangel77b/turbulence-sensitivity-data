...
fig8a <- fig8a+geom_line(data=mike,aes(x=kfrequency,y=Pxx/10),linetype=3)
...
pdf("fig8b2raw.pdf",width=3,height=2,family="Times")
print(fig8a)
dev.off()

# latex version
tikz("fig8b2.tex",standAlone=TRUE,width=3,height=2)
